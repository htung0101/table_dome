...
'''
    ...
    python timeCompare.py --yaml_color1Path /run/user/1000/gvfs/sftp:host=matrix.ml.cmu.edu,user=spshetty/projects/katefgroup/spshetty/NewData/TableDome_y2019_m8_h10_m42_s7_ab/rgb_depth_npy/colorData/Cam1/data.yaml --yaml_color2Path /run/user/1000/gvfs/sftp:host=matrix.ml.cmu.edu,user=spshetty/projects/katefgroup/spshetty/NewData/TableDome_y2019_m8_h10_m42_s7_ab/rgb_depth_npy/colorData/Cam2/data.yaml --yaml_color3Path /run/user/1000/gvfs/sftp:host=matrix.ml.cmu.edu,user=spshetty/projects/katefgroup/spshetty/NewData/TableDome_y2019_m8_h10_m42_s7_ab/rgb_depth_npy/colorData/Cam3/data.yaml --yaml_color4Path /run/user/1000/gvfs/sftp:host=matrix.ml.cmu.edu,user=spshetty/projects/katefgroup/spshetty/NewData/TableDome_y2019_m8_h10_m42_s7_ab/rgb_depth_npy/colorData/Cam4/data.yaml --yaml_color5Path /run/user/1000/gvfs/sftp:host=matrix.ml.cmu.edu,user=spshetty/projects/katefgroup/spshetty/NewData/TableDome_y2019_m8_h10_m42_s7_ab/rgb_depth_npy/colorData/Cam5/data.yaml --yaml_color6Path /run/user/1000/gvfs/sftp:host=matrix.ml.cmu.edu,user=spshetty/projects/katefgroup/spshetty/NewData/TableDome_y2019_m8_h10_m42_s7_ab/rgb_depth_npy/colorData/Cam6/data.yaml --yaml_depth1Path /run/user/1000/gvfs/sftp:host=matrix.ml.cmu.edu,user=spshetty/projects/katefgroup/spshetty/NewData/TableDome_y2019_m8_h10_m42_s7_ab/rgb_depth_npy/depthData/Cam1/data.yaml --yaml_depth2Path /run/user/1000/gvfs/sftp:host=matrix.ml.cmu.edu,user=spshetty/projects/katefgroup/spshetty/NewData/TableDome_y2019_m8_h10_m42_s7_ab/rgb_depth_npy/depthData/Cam2/data.yaml --yaml_depth3Path /run/user/1000/gvfs/sftp:host=matrix.ml.cmu.edu,user=spshetty/projects/katefgroup/spshetty/NewData/TableDome_y2019_m8_h10_m42_s7_ab/rgb_depth_npy/depthData/Cam3/data.yaml --yaml_depth4Path /run/user/1000/gvfs/sftp:host=matrix.ml.cmu.edu,user=spshetty/projects/katefgroup/spshetty/NewData/TableDome_y2019_m8_h10_m42_s7_ab/rgb_depth_npy/depthData/Cam4/data.yaml --yaml_depth5Path /run/user/1000/gvfs/sftp:host=matrix.ml.cmu.edu,user=spshetty/projects/katefgroup/spshetty/NewData/TableDome_y2019_m8_h10_m42_s7_ab/rgb_depth_npy/depthData/Cam5/data.yaml --yaml_depth6Path /run/user/1000/gvfs/sftp:host=matrix.ml.cmu.edu,user=spshetty/projects/katefgroup/spshetty/NewData/TableDome_y2019_m8_h10_m42_s7_ab/rgb_depth_npy/depthData/Cam6/data.yaml --save_dir /run/user/1000/gvfs/sftp:host=matrix.ml.cmu.edu,user=spshetty/projects/katefgroup/spshetty/NewData/TableDome_y2019_m8_h10_m42_s7_ab/rgb_depth_npy
...
'''
    ...
    indexData={"colorIndex1":colorInd1, "colorIndex2":colorInd2, "colorIndex3":colorInd3, "colorIndex4":colorInd4, "colorIndex5":colorInd5, "colorIndex6":colorInd6, "depthIndex1":indices1, "depthIndex2":indices2, "depthIndex3": indices3, "depthIndex4": indices4, "depthIndex5": data5.keys(), "depthIndex6": indices6}
    '''
